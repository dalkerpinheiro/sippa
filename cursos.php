      ...
      <a href="cursos.php">
        <div class="section no-pad-bot" id="index-banner">
          <div class="center espacoTitulo">
            <i class="large material-icons tituloIcone">class</i>
          </div>
          <div class="container">
            <h1 class="header center titulo text-darken-2 espacoPesquisa">Cursos</h1> 
          </div>
        </div>
    </a>
<?php require_once("cursosFuncoes.php");?>
      <div class="section">
        ...
        <table class="highlight centered">
          ...
          ?>
            <tr>
              ...
              <td><?=$curso->nome?></td>
              <td class="center">
                <a onclick="setDadosModalEditarCurso('<?= $curso->cod?>','<?= $curso->nome?>')" class="btn-floating  waves-effect waves-light grey" href="#modal2">
                  <i class="material-icons" href="#modal2">mode_edit</i>
                </a>
              </td>
              <td class="center">
                <a onclick="setDadosModalExcluir('<?= $curso->cod?>');" class="small btn-floating waves-effect waves-light grey darken-2 " href="#modal3"><i class="material-icons">delete</i></a>
              </td>
            </tr>
          <?php } ?>    
          </tbody>
